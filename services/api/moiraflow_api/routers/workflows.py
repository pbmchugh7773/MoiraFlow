...
from ..deps import get_default_tenant, get_session
...
def get_workflow(workflow_id: uuid.UUID, session: Session = Depends(get_session)) -> WorkflowOut:
...
def activate_version(
    workflow_id: uuid.UUID, version: int, session: Session = Depends(get_session)
) -> WorkflowOut:
